...
| 问诊记录 |
|----------|
| ![问诊记录列表页](./docs/assets/github/records.png) |
...
| 阶段 | 内容 |
|------|------|
| **已完成** | 铭铭问诊 MVP、PostgreSQL 多轮 checkpoint、消息落库、游客/正式分流、Gateway、JWT、会话管理、Docker 全栈 |
| **进行中** | **LoRA 微调**（数据 → 训练 → 接入 LLMFactory A/B）、Web/Flutter 体验、RAG |
| **规划中** | 指南 RAG、多模态 Qwen、Sentinel/Seata/OSS、支付挂号、SSE 流式 |
