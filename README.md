...
当前 Web 端已覆盖 **游客登录、会话管理、多轮问诊、检查术语解读、问诊记录列表与续聊、详情抽屉** 等核心体验；移动端、多模态、指南 RAG 与支付挂号仍在路线图中。
...
| **进行中** | **LoRA 微调**（数据 → 训练 → 接入 LLMFactory A/B）、Web/Flutter 体验、RAG |
| **规划中** | 指南 RAG、多模态 Qwen、Seata/OSS、支付挂号、SSE 流式 |
