...
| `v1.0.0` | `dev` 线当前 | 2026-06-20 | **首个正式版**：指南 RAG 全栈、参考指南展示、生产部署与 Milvus 运维文档 |
| `v0.3.3-beta.1` | `0ff7604` | 2026-06-20 | 生产 Docker 部署；Nacos 仅服务发现 |
